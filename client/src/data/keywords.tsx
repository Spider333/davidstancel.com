...
export const keywords: Keyword[] = [
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="text-white/90 mb-6">
          As an experienced speaker, I've delivered talks and participated in panels at major conferences, universities and institutions across Europe. My topics focus on Bitcoin, Ethereum, DeFi, and the intersection of technology and economy.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div className="bg-[#272727]/40 p-5 rounded-lg">
            ...
            <div className="space-y-3">
              ...
              <a href="https://hashtag.zoznam.sk/odbornik-na-kryptomeny-rozhovor/" target="_blank" rel="noopener noreferrer" className="bg-[#1a1a1a] px-4 py-3 rounded-md text-sm flex items-center justify-between">
                Hashtag Interview
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4 ml-1 text-[#00FFAA]">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                </svg>
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="text-white/90 mb-6">
          I dedicated few years of my life to map out the Evolution of Bitcoin and crypto in my book - <a href="https://coinstory.tech/" target="_blank" rel="noopener noreferrer" className="text-[#00FFAA] hover:underline">Coinstory</a>. I now occasionally write on my <a href="https://davidstancel.substack.com/" target="_blank" rel="noopener noreferrer" className="text-[#00FFAA] hover:underline">Substack</a>. You can also check my <a href="https://www.stanceldavid.sk/blog/" target="_blank" rel="noopener noreferrer" className="text-[#00FFAA] hover:underline">old blog</a>.
        </p>
