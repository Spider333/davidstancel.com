...
window.addEventListener('unhandledrejection', (event) => {
  ...
  // Check for missing hostname error often related to OpenGraph tags
  const isHostnameError = errorMsg.includes('hostname') || 
  ...
  console.log('[Handled] Unhandled Promise Rejection:', 
    isWalletError || isHostnameError ? 'Non-critical extension error' : event.reason);
...
window.onerror = function(msg, url, lineNo, columnNo, error) {
  ...
  console.log('[Handled] Global error:', 
    isExtensionError || isServiceWorkerError || isHostnameError ? 
    'Non-critical extension error' : { msg, url, lineNo, columnNo });
...
createRoot(document.getElementById("root")!).render(
  <HelmetProvider>
    <Helmet>
      ...
      <meta property="og:image" content="/images/david-stancel-og.jpg" />
